...
@section('title', 'Tambah Data Teknisi')

@section('content')
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">Tambah Data Teknisi</h5>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" name="nm_teknisi"
                            class="form-control @error('nm_teknisi') is-invalid @enderror" value="{{ old('nm_teknisi') }}"
                            id="nm_teknisi" aria-describedby="nm_teknisi" placeholder="Nama Teknisi">
                        @error('nm_teknisi')
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                            value="{{ old('email') }}" id="email" aria-describedby="email" placeholder="Email Teknisi">
                        @error('email')
                            <span class="invalid-feedback" role="alert">
                                {{ $message }}
                            </span>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" name="t_lahir" class="form-control @error('t_lahir') is-invalid @enderror"
                            value="{{ old('t_lahir') }}" id="t_lahir" aria-describedby="t_lahir"
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="date" name="tgl_aktif" class="form-control @error('tgl_aktif') is-invalid @enderror"
                            value="{{ old('tgl_aktif') }}" id="tgl_aktif" aria-describedby="tgl_aktif"
                            placeholder="Tanggal Lahir">
                        @error('tgl_aktif')
                            <span class="invalid-feedback" role="alert">
                                {{ $message }}
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="alamat_teknisi" class="form-control @error('alamat_teknisi') is-invalid @enderror"
                            id="alamat_teknisi" aria-describedby="alamat_teknisi" placeholder="Alamat Teknisi">{{ old('alamat_teknisi') }}</textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" name="no_telp" class="form-control @error('no_telp') is-invalid @enderror"
                            value="{{ old('no_telp') }}" id="no_telp" aria-describedby="no_telp"
                        ...
                        <select class="form-select @error('kd_cabang') is-invalid @enderror" name="kd_cabang[]"
                            ...
                            @foreach ($cabangs as $cabang)
                                <option value="{{ $cabang->kd_cabang }}"
                                    {{ in_array($cabang->kd_cabang, old('kd_cabang', [])) ? 'selected' : '' }}>
                                    {{ $cabang->nm_cabang }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3 col-md-6 d-none">
                        ...
                        @if($user->hasRole('isp'))
                            <!-- For ISP role, auto-fill the kd_isp and make it readonly -->
                            <input type="text" name="kd_isp" value="{{ $kd_isp }}" readonly class="form-control @error('kd_isp') is-invalid @enderror">
                        @else
                            <!-- For super-admin or others, allow selecting ISP -->
