        ...
        <div class="col-lg-12 d-flex align-items-stretch">
            <div class="card w-100">
                ...
                <div class="p-4 card-body">
                    <a href="{{ route('tiket.create') }}" class="mb-4 btn btn-primary" data-bs-toggle="tooltip"
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle border-bottom-0">
                                            <div class="gap-2 d-flex align-items-center">
                                                ...
                                                <!-- Tombol Edit -->
                                                <a href="{{ route('tiket.edit', Crypt::encryptString($pengaduan->kd_tiket)) }}" title="Edit" data-bs-toggle="tooltip">
