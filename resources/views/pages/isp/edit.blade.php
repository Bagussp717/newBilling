...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('isp.update', Crypt::encryptString($isp->kd_isp)) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" name="nm_isp" class="form-control @error('nm_isp') is-invalid @enderror"
                            value="{{ old('nm_isp', $isp->nm_isp) }}" id="nm_isp" aria-describedby="nm_isp">
                        @error('nm_isp')
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" name="email" class="form-control @error('email') is-invalid @enderror"
                            value="{{ old('email', $isp->user->email) }}" id="email" aria-describedby="email">
                        @error('email')
                            <span class="invalid-feedback" role="alert">
                                {{ $message }}
                            </span>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="password" class="form-label">Password ISP</label>
                        <input type="password" name="password" class="form-control @error('password') is-invalid @enderror"
                            value="{{ old('password') }}" id="password" aria-describedby="password"
                            placeholder="Password ISP (Kosongkan jika tidak diubah)">
                        @error('password')
                            <span class="invalid-feedback" role="alert">
                                {{ $message }}
                            </span>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" name="nm_brand" class="form-control @error('nm_brand') is-invalid @enderror"
                            value="{{ old('nm_brand', $isp->nm_brand) }}" id="nm_brand" aria-describedby="nm_brand">
                        @error('nm_brand')
                            <span class="invalid-feedback" role="alert">
                                {{ $message }}
                            </span>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" id="alamat"
                            aria-describedby="alamat">{{ old('alamat', $isp->alamat) }}</textarea>
                        @error('alamat')
                            <span class="invalid-feedback" role="alert">
                                {{ $message }}
                            </span>
                    ...
                    <div class="mb-3 form-group col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="no_telp" class="form-control @error('no_telp') is-invalid @enderror"
                                value="{{ old('no_telp', ltrim($isp->no_telp, '62')) }}" id="no_telp"
                                aria-describedby="basic-addon1" placeholder="No. Telepon" oninput="formatTelepon(this)"
                                maxlength="15">
                        </div>
                        @error('no_telp')
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="file" id="formFile" name="logo"
                        ...
                        @enderror
                        @if ($isp->logo)
                            <img src="{{ asset('storage/' . $isp->logo) }}" alt="Logo ISP" class="mt-3 img-thumbnail"
                                width="150">
                        @endif
                    </div>
