...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <!-- Form Wrapper -->
            <form action="{{ route('secretMikrotik.update', $pelanggan->username_pppoe) }}" method="POST"
                        ...
                        <div class="my-4 row">
                            <div class="mb-3">
                                ...
                                <input type="text" id="username_pppoe"
                                    ...
                                    value="{{ old('username_pppoe', $pelanggan->username_pppoe) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="password_pppoe"
                                    ...
                                    value="{{ old('password_pppoe', $pelanggan->password_pppoe) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="service_pppoe"
                                    class="form-select @error('service_pppoe') is-invalid @enderror"
                                    name="service_pppoe">
                                    <option value="pppoe"
                                ...
                                <select id="profile_pppoe"
                                    ...
                                    @foreach ($profile as $data)
                                        <option value="{{ $data['name'] }}"
                                            {{ $pelanggan->profile_pppoe == $data['name'] ? 'selected' : '' }}>
                                            {{ $data['name'] }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="tab-pane fade" id="lokasi" role="tabpanel" aria-labelledby="lokasi-tab">
                        ...
                        <div class="row">
                            ...
                            {{-- <div class="mb-3 col-md-6">
                                ...
                                @if ($pelanggan->foto_rumah)
                                    <div class="mt-2">
                                        <img src="{{ asset('storage/foto_rumah/' . $pelanggan->foto_rumah) }}"
