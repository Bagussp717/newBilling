...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <!-- Form Wrapper -->
            <form action="{{ route('secretMikrotik.store') }}" method="POST" enctype="multipart/form-data" class="my-5">
                @csrf
                        ...
                        <div class="my-4 row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control @error('nm_pelanggan') is-invalid @enderror"
                                    name="nm_pelanggan" id="nm_pelanggan" value="{{ old('nm_pelanggan') }}"
                            ...
                            <div class="mb-3 col-md-6"">
                                ...
                                <input type="text" id="t_lahir"
                                    ...
                                    value="{{ old('t_lahir') }}" placeholder="Tempat Lahir">
                                @error('t_lahir')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3 form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="no_telp"
                                        ...
                                        value="{{ old('no_telp', '62') }}" id="no_telp"
                                        aria-describedby="basic-addon1" placeholder="No. Telepon"
                                        oninput="formatTelepon(this)" maxlength="15">
                                </div>
                                @error('no_telp')
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select class="form-control @error('jenis_identitas') is-invalid @enderror"
                                    name="jenis_identitas">
                                    <option value="KTP" disabled
                                        {{ old('jenis_identitas') == 'Pilih Identitas' ? 'selected' : '' }}>
                                        Pilih Identitas
                                    </option>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" id="no_identitas"
                                    ...
                                    value="{{ old('no_identitas') }}" placeholder="Nomor identitas">
                                @error('no_identitas')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <select name="kd_paket" class="form-select @error('kd_paket') is-invalid @enderror"
                                    ...
                                    @foreach ($pakets as $paket)
                                        <option value="{{ $paket->kd_paket }}"
                                            {{ old('kd_paket') == $paket->kd_paket ? 'selected' : '' }}>
                                ...
                                <select name="kd_loket" class="form-select @error('kd_loket') is-invalid @enderror"
                                    ...
                                    @foreach ($lokets as $loket)
                                        <option value="{{ $loket->kd_loket }}"
                                            {{ old('kd_loket') == $loket->kd_loket ? 'selected' : '' }}>
                                            {{ $loket->nm_loket }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3 col-md-6 @if(Auth::user()->hasRole('isp') || Auth::user()->hasRole('teknisi')) d-none @endif">
                                ...
                                <select name="kd_isp" class="form-select @error('kd_isp') is-invalid @enderror"
                                    id="kd_isp">
                                    <option value="" @if(Auth::user()->hasRole('isp') || Auth::user()->hasRole('teknisi')) disabled @endif>Pilih ISP</option>
                                    @foreach ($isps as $isp)
                                ...
                                <select name="kd_odp" class="form-select @error('kd_odp') is-invalid @enderror"
                                    ...
                                    @foreach ($odps as $odp)
                                        <option value="{{ $odp->kd_odp }}"
                                            {{ old('kd_odp') == $odp->kd_odp ? 'selected' : '' }}>
                                            {{ $odp->nm_odp }}</option>
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="my-4 row">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="username_pppoe"
                                    ...
                                    placeholder="Username" name="username_pppoe" value="{{ old('username_pppoe') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="password_pppoe"
                                    ...
                                    placeholder="Password" name="password_pppoe" value="{{ old('password_pppoe') }}">
                                @error('password_ppoe')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="service_pppoe"
                                    class="form-control @error('service_pppoe') is-invalid @enderror"
                                    name="service_pppoe">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="profile_pppoe"
                                    class="form-select @error('profile_pppoe') is-invalid @enderror"
                                    name="profile_pppoe">
                        ...
                        <div class="row">
                                ...
                                <select name="kd_cabang" class="form-select @error('kd_cabang') is-invalid @enderror"
                                    ...
                                    @foreach ($cabangs as $cabang)
                                        <option value="{{ $cabang->kd_cabang }}"
                                            {{ old('kd_cabang', $selectedCabang) == $cabang->kd_cabang ? 'selected' : '' }}>
                                            {{ $cabang->nm_cabang }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="file" name="foto_rumah"
                                    ...
                                    value="{{ old('foto_rumah') }}" id="foto_rumah" aria-describedby="foto_rumah">
                                @error('foto_rumah')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
