@foreach ($secret as $value => $items)
    ...
    <div class="modal fade" id="showPelangganModal{{ $username_pppoe }}" tabindex="-1"
        aria-labelledby="showPelangganModalLabel{{ $username_pppoe }}" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="showPelangganModalLabel{{ $username_pppoe }}">Detail Pelanggan:
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div style="text-wrap: pretty;">
                                ...
                                <p><strong>Tanggal Pemasangan:</strong><br> {{ $pelanggan->tgl_pemasangan ?? ' - ' }}
                                </p>
