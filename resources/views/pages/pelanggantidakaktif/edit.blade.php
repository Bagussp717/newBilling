...
@section('title', 'Edit Pelanggan Tidak Aktif')

@section('content')
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">Edit Pelanggan Tidak Aktif</h5>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            @endif
            <!-- Form Wrapper -->
            <form action="{{ route('pelangganTidakAktif.update', Crypt::encryptString($pelanggan->kd_pelanggan)) }}" method="POST"
