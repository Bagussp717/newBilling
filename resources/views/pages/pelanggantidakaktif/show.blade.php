...
<div class="modal fade" id="showPelangganTidakAktifModal{{ $pelanggan->kd_pelanggan }}" tabindex="-1"
    aria-labelledby="showPelangganTidakAktifModalLabel{{ $pelanggan->kd_pelanggan }}" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="showPelangganTidakAktifModalLabel{{ $pelanggan->kd_pelanggan }}">Detail Pelanggan:
