...
class PelangganController extends Controller
{
    ...
    {
        $query = Pelanggan::whereNotNull('username_pppoe')->where('username_pppoe', '!=', '');
        $cabangs = Cabang::all();
        $pakets = Paket::all();
        ...
        if ($user->hasRole('super-admin')) {
            ...
            $query = $query->whereIn('kd_isp', $kd_isps);
        ...
        // If the request wants JSON, return paginated response
        ...
        // For view, fetch all pelanggans without pagination
    ...
    public function show(Request $request,$kd_pelanggan)
    {
    ...
    public function edit(Request $request, $kd_pelanggan)
    {
