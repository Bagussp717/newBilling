...
class SecretController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate(
            ...
            [
                'tgl_pemasangan.nullable' => 'Tgl pemasangan harus di isi',
                'jenis_identitas.nullable' => 'Jenis identitas harus di isi',
                ...
                'no_telp.nullable' => 'No telp harus di isi',
                'no_telp.min' => 'Nomor telepon harus 12 karakter.',
                'no_telp.max' => 'Nomor telepon harus 13 karakter.',
                'lat.nullable' => 'Latitude harus di isi',
                'long.nullable' => 'Longitude harus di isi',
                'foto_rumah.nullable' => 'Foto rumah harus di isi',
